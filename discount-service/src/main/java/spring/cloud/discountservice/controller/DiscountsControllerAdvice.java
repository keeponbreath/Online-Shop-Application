...
import spring.cloud.discountservice.exception.ExceptionResponse;

import java.time.LocalDateTime;
import java.util.NoSuchElementException;

@RestControllerAdvice
public class DiscountsControllerAdvice {
    @ExceptionHandler(DiscountException.class)
    public ResponseEntity<ExceptionResponse> handle(DiscountException ex, HttpServletRequest request) {
