...
import spring.cloud.oauth2authserver.repo.ClientRepository;
...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public JpaRegisteredClientRepository(ClientRepository clientRepository, PasswordEncoder encoder) {
