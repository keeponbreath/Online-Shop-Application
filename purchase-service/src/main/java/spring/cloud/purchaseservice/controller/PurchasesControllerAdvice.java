...
import spring.cloud.purchaseservice.exception.ExceptionResponse;
...
public class PurchasesControllerAdvice {
    @ExceptionHandler({IllegalAccessException.class, PurchaseException.class})
